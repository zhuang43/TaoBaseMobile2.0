                ...
                <Content>
                        ...
                        <View style={{ alignItems: 'center', paddingHorizontal: 10 }}>
                            ...
                            <View style={{ flexDirection: 'row', paddingHorizontal: 10, flexWrap: 'wrap', justifyContent: 'center' }}>
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', opacity: 0.7, paddingLeft: 8 }}>
                                    ...
                                    <Text style={{ paddingLeft: 5, fontSize: 13 }}>Software Development</Text>
                                </View>
                                <View style={{ flexDirection: 'row', alignItems: 'center', opacity: 0.7, paddingLeft: 8 }}>
                    ...
                    <Card style={{ backgroundColor: '#fff', borderTopColor: '#eee', borderTopWidth: 1 }}>
                        ...
                        <List>
                            <ListItem>
                                <View style={{}}>
                                    <Image source={require('../assets/company2.png')} style={{ width: 30, height: 30, borderRadius: 15, borderWidth: 1, borderColor: '#eee' }} />
                                </View>
                                <Body style={{ paddingLeft: 10 }}>
                                    <Text>Alexander Mcqueen just followed RealCrowd Business</Text>
                                </Body>
                            </ListItem>
                            <ListItem>
                                <View style={{}}>
                                    <Image source={require('../assets/company3.png')} style={{ width: 30, height: 30, borderRadius: 15, borderWidth: 1, borderColor: '#eee' }} />
                                </View>
                                <Body style={{ paddingLeft: 10 }}>
                                    <Text>Alexander Mcqueen just followed Domestic Farm Project</Text>
                                </Body>
                            </ListItem>
                            <ListItem>
                                <View style={{}}>
