	...
	render() {
		return (
			<Card style={styles.container}>
				<TouchableOpacity
					onPress={() => this.props.navigation.navigate('ProjectDetailScreen')}>
					<CardItem>
						<Left>
							<Image
				...
				<CardItem
					...
					<View style={{ paddingLeft: Dimensions.get('window').width / 11 }}>
						<TouchableOpacity
							style={{ justifyContent: 'flex-start', opacity: 0.8 }}>
							<Left>
								<Text style={{ fontWeight: 'normal' }}>Hotness</Text>
								<Text style={{ paddingLeft: 5 }}>
									{this.props.projectHotness}
								</Text>
							</Left>
						</TouchableOpacity>
					</View>
					<View style={{ paddingRight: Dimensions.get('window').width / 11 }}>
						<TouchableOpacity
							style={{ justifyContent: 'flex-start', opacity: 0.8 }}>
							<Left>
								<Text style={{ fontWeight: 'normal' }}>Follow</Text>
								<Text style={{ paddingLeft: 5 }}>
									{this.props.projectFollow}
								</Text>
							</Left>
						</TouchableOpacity>
					</View>
